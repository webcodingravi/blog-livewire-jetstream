<div>
    <div class="flex h-[700px] w-full">
        ...
        <div class="w-full flex flex-col items-center justify-center">
            ...
            <form class="md:w-96 w-80 flex flex-col items-center justify-center" wire:submit.prevent="register">
                <h2 class="text-4xl text-gray-900 font-extrabold">Register</h2>
                <p class="text-sm text-gray-500/90 mt-3">Please Register to continue</p>
                ...
                <div class="w-full relative mt-6">
                    <div>
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24"
                            ...
                            class="lucide lucide-user-icon lucide-user absolute top-4 left-6 text-gray-500">
                ...
                <div class="w-full relative mt-6">
                    <div>
                        <input type="password" placeholder="Password..." wire:model.live.debounce.500ms="password"
                            class="ps-12 bg-transparent text-gray-500/80 placeholder-gray-500/80 text-sm w-full h-full py-3.5 rounded-full focus:ring-0 focus:outline-none focus:border-gray-300 border-gray-300">
                ...
                <div class="w-full mt-4 flex flex-col gap-1">
                    <div class="flex items-center gap-2">
                        <input type="checkbox" wire:model="want_author" id="author"
                            class="w-4 h-4 focus:outline-none focus:ring-0 focus:border-0 cursor-pointer rounded">
                        <label for="author" class="text-sm text-gray-600">
                            Become an Author
                        </label>
                    </div>

                    <p class="text-xs text-gray-400">
                        Author request will be reviewed by admin
                    </p>
                </div>
            ...
            <p class="text-gray-500/90 text-sm mt-4">Already Have an account? <a
                    class="text-indigo-400 hover:underline" href="{{ route('login') }}" wire:navigate>Login</a></p>
