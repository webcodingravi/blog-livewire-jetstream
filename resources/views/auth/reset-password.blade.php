<div>
    <div class="flex h-[700px] w-full">
        ...
        <div class="w-full flex flex-col items-center justify-center">
            ...
            <form class="md:w-96 w-80 flex flex-col items-center justify-center" wire:submit.prevent="resetPassword">
                <h2 class="text-4xl text-gray-900 font-extrabold">Reset Password</h2>
                <p class="text-sm text-gray-500/90 mt-3">Please enter your email to reset your password</p>
                ...
                <button type="submit" wire:loading.attr="disabled" wire:target="resetPassword"
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                        ...
                        wire:loading wire:target="resetPassword">
                        <path d="M12 2v4" />
