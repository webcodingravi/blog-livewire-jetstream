<div>
    <div class="relative" wire:poll.5s="loadNotifications">
        <button class="relative p-2 hover:bg-gray-100 rounded-lg" wire:click="toggle">
        ...
        @if ($open)
            <div class="absolute right-0 mt-2 w-80 bg-white border border-gray-200 rounded-lg shadow-lg z-50">
                <div class="font-medium border-b p-2">Notifications</div>
                <div class="max-h-64 overflow-y-auto">
                    @forelse($notifications as $notification)
                        <div class="p-3 border-b hover:bg-gray-50 flex justify-between items-start">
                            <div class="text-sm text-gray-700">{{ $notification['data']['message'] }}
                                <p class="text-sm text-gray-500">{{ $notification['data']['email'] }}</p>
